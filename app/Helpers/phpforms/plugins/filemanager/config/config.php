...
//    |   |   |   |   |- plugin.min.js
$upload_dir = '/phpforms/files/';
$base_url="http://".$_SERVER['HTTP_HOST'];
$current_path = '../../../files/'; // relative path from filemanager folder to upload folder (with final /)
$thumbs_base_path = '../../../files/thumbnail/'; // relative path from filemanager folder to thumbs folder (with final /)
...
*******************/
$aviary_active=false;
$aviary_key="cd46021df4af299f";
$aviary_secret="639d39d7c7481a7d";
$aviary_version=3;
$aviary_language='fr';
