...
<?php
     if (MESSAGES){include "messages.php";}
?>
<?php
     if (NOTIFICATIONS){include "notifications.php";}
?>
<?php
     if (TASKS){include "tasks.php";}
?>
<?php
     if (PROFILE){include "profile.php";}
?>
            </ul>
          </div>
        </nav>
...
<?php
     if (PROFILE){include "breadcrumb.php";}
?>
        </section>
